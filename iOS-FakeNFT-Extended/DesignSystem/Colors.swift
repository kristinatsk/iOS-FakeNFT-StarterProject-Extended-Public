...
// MARK: - Cart
extension Color {
    static var cartBackground: Color { Color(.screenBackground) }
    static var cartTextPrimary: Color { Color(.primaryText) }
    ...
    static var cartDeleteText: Color { Color(.accentRed) }
}
